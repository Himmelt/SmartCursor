...
public class RenderEntity {
    ...
    public void render(EntityLiving entity, RenderHandler render) {
        ...
        if ((Setting.mobStyle != 3) && (Setting.displayAdvInfoMob)) {
            ...
            String text = String.format(EnumChatFormatting.BOLD + "" + EnumChatFormatting.GOLD + "%s:" + EnumChatFormatting.RESET + " %d/%d", entity.getName(), Integer.valueOf((int) entity.getHealth()), Integer.valueOf((int) entity.getMaxHealth()));
        ...
        if (Setting.mobStyle == 0) {
            ...
            String text = String.format("%.0fx", Float.valueOf(entity.getHealth()));
