...
public class RenderPlayer {
    ...
    public void render(EntityPlayer player, RenderHandler render) {
        ...
        if (Setting.playerStyle == 0) {
            ...
            String text = String.format(TextFormatting.BOLD + "" + TextFormatting.GOLD + "%s:" + TextFormatting.RESET + " %d/%d", new Object[]{player.getDisplayNameString(), Integer.valueOf((int) player.getHealth()), Integer.valueOf((int) player.getMaxHealth())});
        ...
        if (Setting.playerStyle == 1) {
            ...
            String text = String.format("%.0fx", new Object[]{Float.valueOf(player.getHealth())});
