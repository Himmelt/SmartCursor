...
public class GuiSMSettings extends net.minecraft.client.gui.GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiOptionButton(7, w - btnW - 5, h - btnH - 5, btnW, btnH, I18n.translateToLocal("smartcursor.gui.advanced")));
        buttonList.add(new GuiOptionButton(10, 5, h - btnH - 5, btnW, btnH, I18n.translateToLocal("smartcursor.gui.moduleList")));
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.title"), w / 2, (h / 7 - 10) / 2, 0xFFFFFF);
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.isEnabled"), w / 4, h / 7 - 60 + 50, 0xFFFFFF);
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.showBlockDamage"), w / 4, h / 7 - 60 + 50 + (btnH + fH / 4) * 1, 0xFFFFFF);
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.showMobHealth"), w / 4, h / 7 - 60 + 50 + (btnH + fH / 4) * 2, 0xFFFFFF);
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.showDropInfo"), w / 4, h / 7 - 60 + 50 + (btnH + fH / 4) * 3, 0xFFFFFF);
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.showDropEnchantments"), w / 4, h / 7 - 60 + 50 + (btnH + fH / 4) * 4, 0xFFFFFF);
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.showDurability"), w / 4, h / 7 - 60 + 50 + (btnH + fH / 4) * 5, 0xFFFFFF);
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.showXPorbInfo"), w / 4, h / 7 - 60 + 50 + (btnH + fH / 4) * 6, 0xFFFFFF);
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.showPlayerInfo"), w / 4, h / 7 - 60 + 50 + (btnH + fH / 4) * 7, 0xFFFFFF);
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.showBlockInfo"), w / 4, h / 7 - 60 + 50 + (btnH + fH / 4) * 8, 0xFFFFFF);
