...
public class GuiLoadedModules extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiOptionButton(100, w - btnW - 25, h - 5 - btnH, btnW, btnH, I18n.translateToLocal("smartcursor.gui.switch")));
    }
    ...
    public void func_73863_a(int width, int height, float zLevel) {
        ...
        drawCenteredString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.loadedModules"), this.width / 2, 16, 0xFFFFFF);
        drawString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.class") + ": " + field_146450_f.moduleClass, 25, height - fh * 3 - 5, 0xFFFFFF);
        drawString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.name") + ": " + field_146450_f.moduleName, 25, height - fh * 2 - 5, 0xFFFFFF);
        drawString(fontRendererObj, I18n.translateToLocal("smartcursor.gui.author") + ": " + field_146450_f.moduleAuthor, 25, height - fh - 5, 0xFFFFFF);
